# Apresentações KraftSun no site (pasta /apresentacao)

## O que tem no pacote
- `apresentacao/index.html`: as 6 apresentações para call no Meet (Geral, Diagnóstico, Monitoramento, O&M, Financeiro, Conta), com a Ficha do lead, o modo apresentador e as calculadoras.
- `apresentacao/guia/index.html`: o Guia do Consultor.
...
3. Arraste a **pasta `apresentacao` inteira** (a pasta, não só os arquivos de dentro). O GitHub mantém a subpasta `guia`.
4. Mensagem do commit: `Apresentações e Guia do Consultor (v2)`. Clique em **Commit changes**.
...
## Como usar na call
1. Abra /apresentacao/, preencha a **Ficha do lead** (empresa, nome, cidade, usinas, visitas às cegas, custo da visita e acompanhamento por usina, que começa em R$ 30).
2. Clique em **Apresentar** e abra o mesmo link em outra aba. Na sua aba, aperte **P** (modo apresentador: falas, próximo slide, cronômetro e a ficha para ajustar ao vivo). No Meet, compartilhe a outra aba.
3. Tudo que você digita (ficha ou calculadora) aparece nas duas abas na hora.
